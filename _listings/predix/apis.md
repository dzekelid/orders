...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/orders/master/_listings/predix/apis.md
specificationVersion: "0.14"
apis:
- name: Intelligent Mapping - Update order of layers
  x-api-slug: v1mapsmapidorderlayers-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/orders/master/_listings/predix/v1mapsmapidorderlayers-post-openapi.md
- name: Intelligent Mapping - Update order of layers
  x-api-slug: v1mapsmapidorderlayers-post
  description: Updates the order of layers for a given map.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/predix-vector-logo.png

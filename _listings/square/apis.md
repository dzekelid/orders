...
apis:
- name: Square Connect - Provides summary information for a merchant's online store
    orders.
  x-api-slug: v1location-idorders-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/orders/master/_listings/square/v1location-idorders-get-openapi.md
- name: Square Connect - Provides comprehensive information for a single online store
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/orders/master/_listings/square/v1location-idordersorder-id-get-openapi.md
- name: Square Connect - Provides comprehensive information for a single online store
    order, including the order's history.
  x-api-slug: v1location-idordersorder-id-get
  description: Provides comprehensive information for a single online store order,
...
- name: 'Square Connect - Updates the details of an online store order. Every update
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/orders/master/_listings/square/v1location-idordersorder-id-put-openapi.md
- name: Square Connect - Provides comprehensive information for a single online store
    order, including the order's history.
  x-api-slug: v1location-idordersorder-id-get
  description: Provides comprehensive information for a single online store order,
